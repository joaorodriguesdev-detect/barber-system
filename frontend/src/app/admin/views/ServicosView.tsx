      ...
      <div className="bg-[#121214] border border-white/[0.05] rounded-3xl p-6 md:p-8">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
          <div>
            ...
            <p className="text-zinc-500 text-sm mt-1">Defina o que sua barbearia oferece.</p>
          </div>
          <button
            onClick={() => {
        ...
        {loadingServices ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {adminServices.map((svc) => (
              <div
                key={svc.id}
                className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-[#0A0A0A] border border-white/5 rounded-2xl p-5 hover:border-violet-500/30 transition"
              >
                <div>
