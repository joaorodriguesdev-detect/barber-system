  ...
  return (
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-5 gap-5 mb-8">
        <div className="xl:col-span-2 bg-[#121214] border border-white/[0.05] rounded-3xl p-6 relative overflow-hidden group flex flex-col justify-between">
          ...
          <div className="relative z-10">
            ...
            <p className="text-xs text-emerald-400 font-medium">+18% este mês</p>
          </div>
        ...
        <div className="bg-[#121214] border border-white/[0.05] rounded-3xl p-6 relative overflow-hidden group flex flex-col justify-center">
          ...
          <p className="text-xs text-emerald-400 font-medium">Cortes finalizados</p>
        </div>
        ...
        <div className="bg-[#121214] border border-white/[0.05] rounded-3xl p-6 relative overflow-hidden group flex flex-col justify-center">
          <div className="absolute top-0 right-0 w-32 h-32 bg-violet-500/10 blur-[50px] -mr-10 -mt-10 transition-all group-hover:bg-violet-500/20"></div>
          <div className="flex items-center justify-between mb-4">
          ...
          <p className="text-xs text-violet-400 font-medium">Volume do período</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
        ...
        <div className="bg-gradient-to-b from-violet-600/10 to-[#121214] border border-violet-500/20 rounded-3xl p-6 relative overflow-hidden">
          <h3 className="text-violet-300 text-sm font-bold uppercase tracking-widest mb-6">Visão Geral</h3>
