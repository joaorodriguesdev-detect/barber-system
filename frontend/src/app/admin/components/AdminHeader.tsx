      ...
      <div className="flex items-center justify-between px-6 py-4">
        ...
        <div className="flex items-center gap-3">
          ...
          >
            ...
            {pendingAppointmentsCount > 0 && (
              <span className="absolute -top-1 -right-1 flex h-4 w-4">
                ...
                <span className="relative flex justify-center items-center rounded-full h-4 w-4 bg-violet-500 text-[9px] font-bold text-white">
                  {pendingAppointmentsCount}
                </span>
              </span>
            )}
          ...
          <div className="hidden md:flex items-center gap-3 pl-4 border-l border-white/[0.05] ml-2">
            <div className="w-8 h-8 rounded-full bg-gradient-to-tr from-violet-600 to-blue-600 flex items-center justify-center text-xs font-bold text-white shadow-lg">
